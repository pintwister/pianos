...
<link href="./style/stylePayCharge.css" rel="stylesheet" type="text/css" media="all" /> 
<!-- link calendar files  -->
...
<form name="form" action="paycharge.php" method="post">
			...
			'controlname': 'date'
              ...
              <div id="ServRecLabel">
                   ...
                   <input class="ServRecInput" tabindex=2 maxlength="10" size=10 name="servamnt" type="text" id="servamnt" value="<?php echo $servamnt?>">
                  
              <div id="CheckLabel">
                   Check #
              </div>
                   <input class="CheckInput" tabindex=3 maxlength="10" size=10 name="chkno" type="text" id="chkno" value="<?php echo $chkno?>">
            
              <div id="CommentsLabel">
                   Comments:
              </div>
              <div id="CommentsInput">
                   <textarea tabindex=4 name="comment" rows="4" cols="96" id="textarea2"><?php echo $comment?></textarea>
              </div>
<br>
