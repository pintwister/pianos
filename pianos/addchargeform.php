...
<link href="./style/styleAddCharge.css" rel="stylesheet" type="text/css" media="all" /> 
<!-- link calendar files  -->
...
<form name="form" action="addcharge.php" method="post">
<div id="ServiceDateLabel">
			...
			'controlname': 'date'
              ...
              <div id="PartsRecLabel">
                   ...
                   <input class="PartsRecInput" tabindex=3 maxlength="10" size=10 name="partamnt" type="text" value="<?php echo $partamnt?>">
                             
              <div id="CommentsLabel">
                   Comments:
              </div>
              <div id="CommentsInput">
                   <textarea tabindex=4 name="comment" rows="4" cols="96"><?php echo $comment?></textarea>
              </div>
<br>
